...
<div class="rounded-box bg-base-100 mx-auto max-w-3xl p-8 shadow-md">
  ...
  <div class="bg-base-200 mb-8 rounded-lg p-4">
    <p class="text-base-content/80 text-lg italic">
      At EV Estimator Hub, we believe in transparency and respect for your privacy. This policy explains our minimal
  ...
  <section class="mb-8">
    ...
    <div class="text-base-content/80 mb-4 space-y-2">
      <p>
        We use <a href="https://umami.is/" target="_blank" rel="noopener noreferrer" class="link link-primary"
          >Umami Analytics</a
        >, a privacy-focused open-source alternative to Google Analytics. Unlike conventional analytics tools, Umami:
      </p>
    </div>
